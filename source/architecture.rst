...
-  :doc:`Tiered </architecture/tiered>`: Private Chef with a horizontally scaled frontend and single backend.
-  :doc:`High Availability </architecture/high_availability>`: Private Chef with N frontends and a clustered backend pair.
